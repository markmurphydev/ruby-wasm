//! Attribution: Copied wholesale from `syn` crate:
//!     https://docs.rs/syn/latest/src/syn/parse.rs.html#246-262
//!
...
use crate::parse::syn::token_buffer::Cursor;
use crate::result::{Error, Result};

mod error {
    use crate::parse::syn::token_buffer::{open_span_of_group};
    use super::*;
    ...
    pub(crate) fn new_at<T: Display>(scope: Span, cursor: Cursor, message: T) -> Error {
        if cursor.eof() {
            ...
            let span = open_span_of_group(cursor);
