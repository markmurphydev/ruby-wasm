...
//!     https://docs.rs/syn/latest/src/syn/buffer.rs.html#32-36
//!     I also pasted in some dependencies from elsewhere in the crate.
...
fn Lifetime(marker: TokenMarker) -> Lifetime {
    match marker {}
}
